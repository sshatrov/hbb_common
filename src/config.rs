...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("RustDesk (itprogress.ru)".to_owned());
...
pub const RENDEZVOUS_SERVERS: &'static [&'static str] = &[
    "rust.itprogress.ru" //or the IP address
];
// pub const RS_PUB_KEY: &str = "OeVuKk5nlHiXp+APNn0Y3pC1Iwpwn44JGqrQCsWqmBw=";
pub const RS_PUB_KEY: &'static str = "zY5y4LeywTri8YeRRX0CQg6EGEaJpCYzQwaUgV2WQpA=";
